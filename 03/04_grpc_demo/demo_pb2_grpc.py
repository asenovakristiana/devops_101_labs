...
class DemoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTime = channel.unary_unary(
                '/demo.DemoService/GetTime',
                request_serializer=demo__pb2.Empty.SerializeToString,
                response_deserializer=demo__pb2.TimeResponse.FromString,
                _registered_method=True)
        self.EchoMessage = channel.unary_unary(
                '/demo.DemoService/EchoMessage',
...
def add_DemoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetTime': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=demo__pb2.TimeResponse.SerializeToString,
            ),
...
class DemoService(object):
    ...
    def GetTime(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            demo__pb2.TimeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
